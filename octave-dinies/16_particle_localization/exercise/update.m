...
function weights = update(samples, weights, landmarks, observations)
	...
	for i=1:num_particles
        ...
        sample_coords = [ measurement.x_pose , measurement.y_pose ];
				delta = curr_h - sample_coords' ;
    ...
    p_zt_giv_xt=  exp( - (dropped_measurements * l_miss)  - sum_of_negative_log_likelihood);
		weights(i) *= p_zt_giv_xt;
